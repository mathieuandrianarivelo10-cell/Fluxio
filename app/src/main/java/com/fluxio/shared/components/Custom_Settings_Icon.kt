...
val SettingsActive: ImageVector
    get() {
        if (_settingsActive != null) return _settingsActive!!
        _settingsActive = ImageVector.Builder(
...
private var _settingsActive: ImageVector? = null

@Suppress("CheckReturnValue")
val SettingsInactive: ImageVector
    get() {
        if (_settingsInactive != null) return _settingsInactive!!
        _settingsInactive = ImageVector.Builder(
        ...
        return _settingsInactive!!
    }

private var _settingsInactive: ImageVector? = null

@Composable
fun CustomSettingsMenuIcon(selected: Boolean, modifier: Modifier = Modifier, tint: Color = Color.White) {
    Icon(
        imageVector = if (selected) SettingsActive else SettingsInactive,
